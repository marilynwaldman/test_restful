defmodule TestRestfulWeb.UserLive.Edit do
  ...
  def render(assigns), do: TestRestfulWeb.UserView.render("edit.html", assigns)

  def handle_event("validate", %{"user" => params}, socket) do
    changeset =
      socket.assigns.user
      |> TestRestful.Accounts.change_user(params)
